...
const SignupSchema = Yup.object().shape({
  password: Yup.string().min(4, "Too Short!").max(8, "Too Long!").required("Лимит на символы"),
});
    ...
    >
      {({ isSubmitting, errors, touched, values, handleChange }) => (
        <div className={style.formContainer}>
            ...
            <div className="formFieldWrap">
              ...
              <div className="formFieldWrapNotification">
                ...
                <span className={style.subSpan}>
                  {errors.password ? errors.password : "Лимит на символы"}
                </span>
              </div>
            </div>
            <div className="formFieldWrap">
          ...
          <span className={style.textLogin}>
            Уже есть логин?{" "}
            <Link
