...
export const Comment: FC<commentProps> = ({isReplay = false}) => {
    ...
    return (
        <div className={isReplay ? `${style.replayContainer} ${style.commenContainer}` : style.commenContainer}>
            ...
            <p className={style.textComment}>Lorem ipsum dolor sit amet, consectetur adipisicing elit. A animi at,
                consectetur deserunt eius esse laudantium minima, molestias neque nobis obcaecati perspiciatis
                veniam!</p>
